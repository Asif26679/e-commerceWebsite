        ...
        >
         <div className="absolute inset-0 bg-gradient-to-b from-black/60 to-black/20">
          <div className="relative z-10 flex items-center justify-center min-h-screen px-6">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white leading-tight  drop-shadow-lg font-lequire ">Discover Your Style...</h1>
         ...
         <p>World's best earphone company</p>   
          <Link
              to="/products"
              className="inline-block mt-6 bg-green-700 text-white px-6 py-3 rounded-2xl text-lg hover:bg-green-800 transition duration-200 font-lequire"          
              >Shop Now</Link>
                </div>  
